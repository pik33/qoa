...
function qoa_encode_header(qoa:Pqoa_desc; bytes:Pbyte):cardinal; forward;
function qoa_encode_frame(sample_data:Psmallint;qoa:Pqoa_desc; frame_len:cardinal;bytes:Pbyte):cardinal; forward;
procedure qoa_encode(sample_data:Psmallint;qoa:Pqoa_desc; out_len:Pcardinal);

function qoa_max_frame_size(qoa:Pqoa_desc):cardinal; forward;
function qoa_decode_header(bytes:Pbyte; size:integer; qoa:Pqoa_desc):cardinal; forward;
function qoa_decode_frame(bytes:Pbyte; size:cardinal; qoa:Pqoa_desc; sample_data:Psmallint; frame_len:Pcardinal):cardinal; forward;
function qoa_decode(bytes:Pbyte; size: integer; file_:Pqoa_desc):Psmallint; forward;
function qoa_write(filename:Pchar; sample_data:Psmallint; qoa:Pqoa_desc):integer; forward;
procedure qoa_read(filename:Pchar; qoa:Pqoa_desc); forward;
